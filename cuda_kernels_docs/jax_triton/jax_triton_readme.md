...
Sources:
- https://raw.githubusercontent.com/jax-ml/jax-triton/main/README.md
...
See [the examples directory](https://github.com/jax-ml/jax-triton/tree/main/examples), especially
[fused_attention.py](https://github.com/jax-ml/jax-triton/blob/main/examples/fused_attention.py)
and [the fused attention ipynb](https://github.com/jax-ml/jax-triton/blob/main/examples/JAX_%2B_Triton_Flash_Attention.ipynb).
...
## Additional Notes (from GitHub repo page)

- Latest release: v0.3.1 (February 2026)
- License: Apache 2.0
- jax-triton only works with JAX on GPU (CUDA or ROCm)
- Bleeding-edge install: `pip install 'jax-triton @ git+https://github.com/jax-ml/jax-triton.git'`
